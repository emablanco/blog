...
Si se ejecuta el comando _ifconfig_ se puede ver la descripción de la interfaz monitor. Teniendo en cuenta que el ataque se realizara a través de esta interfaz, no se debe dejar huellas. Por eso es necesario que se cambie la dirección **MAC**.
...
Con esto se logra capturar el **HANDSHAKE** al caul por podio de un diccionario de furza bruta se podrá obtener la clave de la red WiFi.
...
Con el diccionario creado se puede crackear el **handshake** que se capturo.
