...
```
En autorun se configura el binario **nginx** para que se ejecute al inicio del sistema 
En autorun se configura el binario **nginx** seguido del parametro **-s stop** para detener el servicio. 
